    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}" class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-semibold text-gray-900">Sama Santé</span>
                    </a>
                </div>
            </div>
            <!-- Navigation Links -->
            <div class="hidden space-x-8 sm:ml-10 sm:flex">
                ...
                <a href="{{ route('patient.emergency') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium {{ request()->routeIs('patient.emergency') ? 'text-red-600 border-b-2 border-red-600' : 'text-gray-500 hover:text-red-600 hover:border-b-2 hover:border-red-300' }}">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
